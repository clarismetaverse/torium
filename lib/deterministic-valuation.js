...
export function buildDeterministicValuation({ profileSet, sourceRow, listing, doorEngine }) {
  ...
  return {
    ...
    positive_signals: [
      ...
      `market_sentiment:${profile.market_sentiment?.label || 'not_available'}`,
    ...
    red_flags: [
      ...
      'City-zone asking-price benchmark, small-unit premium and saleable-area ratio are provisional assumptions.',
      ...(profile.provisional_fallback ? ['No specific Milan macro-zone matched; citywide fallback benchmark used.'] : []),
